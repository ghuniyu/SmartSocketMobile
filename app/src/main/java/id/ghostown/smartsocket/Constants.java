...
public class Constants {
    public static final String TAG_BT_ADD = "bluetooth_address";
    public static final String TAG_BT_INF = "bluetooth_info";
    ...
    static final UUID TAG_UUID = UUID.fromString("00001101-0000-1000-8000-00805F9B34FB");
